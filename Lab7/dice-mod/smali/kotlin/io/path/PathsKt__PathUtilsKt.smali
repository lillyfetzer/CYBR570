...
.method private static final copyTo(Ljava/nio/file/Path;Ljava/nio/file/Path;Z)Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1, p2}, Landroidx/transition/WindowIdApi18$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)Ljava/nio/file/Path;
...
.method public static final varargs createParentDirectories(Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    .line 566
    invoke-static {p0}, Landroidx/transition/WindowIdApi18$$ExternalSyntheticApiModelOutline0;->m$1(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-static {v0, v2}, Landroidx/transition/WindowIdApi18$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {v0, v1}, Landroidx/transition/WindowIdApi18$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
...
.method private static final div(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    .line 996
    invoke-static {p0, p1}, Landroidx/transition/WindowIdApi18$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method public static final getExtension(Ljava/nio/file/Path;)Ljava/lang/String;
    ...
    .line 47
    invoke-static {p0}, Landroidx/transition/WindowIdApi18$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method private static final varargs isDirectory(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {p0, p1}, Landroidx/transition/WindowIdApi18$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
...
.method public static final visitFileTree(Ljava/nio/file/Path;Ljava/nio/file/FileVisitor;IZ)V
    ...
    .line 1085
    :goto_0
    invoke-static {p0, p3, p2, p1}, Landroidx/transition/WindowIdApi18$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;Ljava/util/Set;ILjava/nio/file/FileVisitor;)Ljava/nio/file/Path;
