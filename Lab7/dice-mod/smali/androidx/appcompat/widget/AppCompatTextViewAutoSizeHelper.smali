...
.method private createStaticLayoutForMeasuring(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    .line 777
    invoke-static {p1, v2, v0, v1, p3}, Landroidx/activity/ImmLeaksCleaner$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/CharSequence;IILandroid/text/TextPaint;I)Landroid/text/StaticLayout$Builder;

    move-result-object p1

    .line 780
    invoke-static {p1, p2}, Landroidx/activity/ImmLeaksCleaner$$ExternalSyntheticApiModelOutline0;->m(Landroid/text/StaticLayout$Builder;Landroid/text/Layout$Alignment;)Landroid/text/StaticLayout$Builder;
    ...
    .line 781
    invoke-static {p2, p3, v0}, Landroidx/activity/ImmLeaksCleaner$$ExternalSyntheticApiModelOutline0;->m(Landroid/text/StaticLayout$Builder;FF)Landroid/text/StaticLayout$Builder;
    ...
    invoke-static {p2, p3}, Landroidx/activity/ImmLeaksCleaner$$ExternalSyntheticApiModelOutline0;->m(Landroid/text/StaticLayout$Builder;Z)Landroid/text/StaticLayout$Builder;
    ...
    .line 785
    invoke-static {p3}, Landroidx/activity/ImmLeaksCleaner$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/widget/TextView;)I

    move-result p3

    invoke-static {p2, p3}, Landroidx/activity/ImmLeaksCleaner$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/text/StaticLayout$Builder;I)Landroid/text/StaticLayout$Builder;
    ...
    .line 786
    invoke-static {p3}, Landroidx/activity/ImmLeaksCleaner$$ExternalSyntheticApiModelOutline0;->m$2(Landroid/widget/TextView;)I

    move-result p3

    invoke-static {p2, p3}, Landroidx/activity/ImmLeaksCleaner$$ExternalSyntheticApiModelOutline0;->m$2(Landroid/text/StaticLayout$Builder;I)Landroid/text/StaticLayout$Builder;
    ...
    .line 787
    :cond_0
    invoke-static {p2, p4}, Landroidx/activity/ImmLeaksCleaner$$ExternalSyntheticApiModelOutline0;->m(Landroid/text/StaticLayout$Builder;I)Landroid/text/StaticLayout$Builder;
    ...
    .line 797
    :goto_0
    invoke-static {p1}, Landroidx/activity/ImmLeaksCleaner$$ExternalSyntheticApiModelOutline0;->m(Landroid/text/StaticLayout$Builder;)Landroid/text/StaticLayout;
...
.method private setRawTextSize(F)V
    ...
    invoke-static {p1}, Landroidx/activity/ImmLeaksCleaner$$ExternalSyntheticApiModelOutline0;->m(Landroid/widget/TextView;)Z
